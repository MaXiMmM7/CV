...
public:
  explicit Unit(geo2d::Point position):unit(position){}
...
const geo2d::Point& Get() const {return unit;}
...
public:
  explicit Building(geo2d::Rectangle geometry):unit(geometry){}
  ...
  bool CollideWith(const Unit& that) const ;
     ...
     const geo2d::Rectangle& Get() const {return unit;}
private:
     geo2d::Rectangle unit;

};

class Tower:public GameObject {
public:
  explicit Tower(geo2d::Circle geometry):unit(geometry){}
  ...
  bool Collide(const GameObject& that) const override{
     ...
     const geo2d::Circle& Get() const {return unit;}
     private:
     geo2d::Circle unit;
...
public:
	...
	explicit Fence(geo2d::Segment geometry):unit(geometry){}
	...
	bool Collide(const GameObject& that) const override{
	   ...
	   const geo2d::Segment& Get() const {return unit;}
...
bool Unit::CollideWith(const Unit& that) const {
	   return geo2d::Collide(unit,that.Get());
   }
