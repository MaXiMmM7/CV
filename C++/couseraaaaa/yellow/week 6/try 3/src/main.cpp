...
void TestEventComparisonNode_U() {
	{
		EventComparisonNode ecn(Comparison::Equal, "abc");
		Assert(ecn.Evaluate(Date{ 0, 1, 1 }, "abc"), "EventComparison 1");
		Assert(!ecn.Evaluate(Date{ 0, 1, 1 }, "cbe"), "EventComparison 2");
...
void TestLogicalOperationNode_U() {
	{
		LogicalOperationNode lon(LogicalOperation::And, make_shared<EmptyNode>(), make_shared<EmptyNode>());
		Assert(lon.Evaluate(Date{ 0, 1, 1 }, "abc"), "LogicalOperationNode 1");
	}
...
/*
  	  ...
  	  tr.RunTest(TestDatabase, "Тест базы данных с GitHub");*/
         ...
         tr.RunTest(TestDate_U, "TestDate_U");
    	  tr.RunTest(TestParseDate_U, "TestParseDate_U");
    	  tr.RunTest(TestDateComparison_U, "TestDateComparison_U");
    	  tr.RunTest(TestDateComparisonNode_U, "TestDateComparisonNode_U");
    	  tr.RunTest(TestEventComparisonNode_U, "TestEventComparisonNode_U");
    	  tr.RunTest(TestLogicalOperationNode_U, "TestLogicalOperationNode_UТест ");
    	  tr.RunTest(TestEmptyNode_U, "TestEmptyNode_U");

       	  tr.RunTest(TestDbAdd_U, "TestDbAdd_U");
       	  tr.RunTest(TestDbFind_U, "TestDbFind_U");
       	  tr.RunTest(TestDbLast_U, "TestDbLast_U");
       	tr.RunTest(TestDbRemoveIf_U, "TestDbRemoveIf_U");
