...
class Triangle:public Figure{
	public:Triangle(const string& Name,const double& A,const double& B,const double& C):
...
class Rect:public Figure{
	public:Rect(const string& Name, const double& A,const double& B):Figure(Name),a(A),b(B){}
	string Name() const override{ return name;}
...
class Circle:public Figure{
	public:Circle(const string& Name,const double& R):Figure(Name),r(R){}
	string Name() const override{ return name;}
